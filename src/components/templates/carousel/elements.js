...
import RoundKeyboardArrowLeft from 'react-md-icon/dist/RoundKeyboardArrowLeft';
import RoundKeyboardArrowRight from 'react-md-icon/dist/RoundKeyboardArrowRight';
...
const Left = styled(RoundKeyboardArrowLeft)`
  font-size: 2rem;
...
const Right = styled(RoundKeyboardArrowRight)`
  font-size: 2rem;
  color: ${props => props.theme.color.default};
  &:hover {
    color: ${props => props.theme.color.secondary};
...
export { CarouselContainer, Left, Right };
